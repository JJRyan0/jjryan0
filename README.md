...
| Project | Description |
|--------|-------------|
| [💡 Healthcare Sentiment Analysis using OpenAI API](https://github.com/JJRyan0/healthcare-sentiment-analysis-openai/tree/main) | This project demonstrates how to perform sentiment analysis on healthcare company reviews using the OpenAI API (ChatGPT). The model classifies reviews as Positive, Negative, or Mixed, helping organizations understand customer feedback and improve services. |
